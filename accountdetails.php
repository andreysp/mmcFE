...
?>
	...
	<!-- Account details -->
		...
		<table>
			...
			<tr><td><a href="api.php?api_key=<?php echo antiXss($userApiKey) ?>" style="color: blue" target="_blank">API</a> Key: </td><td><h6><font size="1"><?php echo antiXss($userApiKey); ?></font></h6></td></tr>
			...
			<tr><td>Automatic Payout Threshold: </td><td valign="top"><input type="text" name="payoutThreshold" value="<?php echo antiXss($payoutThreshold);?>" size="5" maxlength="5"> <font size="1">[0.10-25 LTC. Set to '0' for no auto payout]</font></td></tr>
